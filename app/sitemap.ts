...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/shop/men`, lastModified: now, changeFrequency: "daily", priority: 0.8 },
    ...
    { url: `${baseUrl}/collections/summer-26`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    ...
    { url: `${baseUrl}/policies/exchange`, lastModified: now, changeFrequency: "yearly", priority: 0.3 },
    { url: `${baseUrl}/policies/returns`, lastModified: now, changeFrequency: "yearly", priority: 0.3 },
    { url: `${baseUrl}/policies/refunds`, lastModified: now, changeFrequency: "yearly", priority: 0.3 },
    { url: `${baseUrl}/policies/shipping`, lastModified: now, changeFrequency: "yearly", priority: 0.3 },
  ];
